...
public class ObjListaNota implements Serializable, Parcelable
{
    ...
    public final static Creator<ObjListaNota> CREATOR = new Creator<ObjListaNota>() {


        @SuppressWarnings({
            "unchecked"
        })
        public ObjListaNota createFromParcel(Parcel in) {
            return new ObjListaNota(in);
        }

        public ObjListaNota[] newArray(int size) {
            return (new ObjListaNota[size]);
        }

    }
    ;
    private final static long serialVersionUID = 1473204982609787719L;

    protected ObjListaNota(Parcel in) {
